...
class Desenvolvedor
{
    public string $nome = "Daniel Zanni";
    public string $email = "danielzanni07@gmail.com";
    public int $idade = 20;
    ...
    public array $formacoes_academicas = [
        ...
        "Ensino Técnico"   => "Técnico em Desenvolvimento de Sistemas",
    ];
    ...
    public function apresentar(): void
    {
        print_r([
            ...
            "formações" => $this->formacoes_academicas,
        ]);
    }
}
